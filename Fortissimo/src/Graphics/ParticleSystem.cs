...
namespace Fortissimo
{
    ...
    public abstract class ParticleSystem : DrawableGameComponent
    {
        ...
        public void AddParticles(Vector2 where, Color color)
        {
            ...
            for (int i = 0; i < numParticles && freeParticles.Count > 0; i++)
            {
                ...
                InitializeParticle(p, where, color);               
            }
        }
        ...
        /// </param>
        protected virtual void InitializeParticle(Particle p, Vector2 where, Color color)
        {
            ...
            p.Initialize(
                ...
                lifetime, scale, rotationSpeed, color);
        }
